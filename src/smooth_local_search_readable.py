...
class SmoothLocalSearchReadable(AbstractOptimizer):
    ...
    def optimize(self) -> Set[E]:
        ...
        solution_set1: Set[E] = self._smooth_local_search_v2(delta=delta1, delta_prime=delta_prime1)
        solution_set2: Set[E] = self._smooth_local_search_v2(delta=delta2, delta_prime=delta_prime2)
    ...
    def _smooth_local_search_v2(self, delta: float, delta_prime: float) -> Set[E]:
        """
